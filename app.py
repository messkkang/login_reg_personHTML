...
db = pymysql.connect(host="106.12.59.19", user="root", password="kangkang123!", database="mysql", charset="utf8")
...
def login_handle():
    if request.method == "GET":
        ...
        if res:
            ...
            return render_template("user_center2.html")
        else:
            # 登录失败
...
def send_sms_code(phone):
    ...
    try:
        ...
        params = {
            ...
            "tpl_id": "189114",  # 您申请的短信模板ID，根据实际情况修改
            "tpl_value": "#code#=%s" % verify_code,  # 您设置的模板变量，根据实际情况修改
            "key": "d1946d5ebc776e50eeb775bb697d18ac",  # 应用APPKEY(应用详细页查询)
        }
